<h4> 🔒 For best security, use a unique, strong, and long username/password combination </h4>
...
- [:octicons-arrow-right-24: Check out more security tips here](http://127.0.0.1:8000/guides/security_tips)
...
=== "Step 1"
    <figure markdown>
        ![HW_wallet_enable](../assets/guides/create_account/create_account_1.PNG){ width="600" }
        <figcaption>Open Zelcore and tap "Sync/Register" Account on this Device</figcaption>
    </figure>

=== "Step 2"
    <figure markdown>
        ![HW_wallet_step2](../assets/guides/create_account/create_account_3.PNG){ width="600" }
        <figcaption>Type your desired username and password</figcaption>
    </figure>

=== "Steps 3 & 4"
    <figure markdown>
        ![HW_wallet_step4](../assets/guides/create_account/create_account_4.PNG){ width="600" }
