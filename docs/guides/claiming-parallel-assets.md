...
4. Refer to [Troubleshooting Flux Node Status Issues](/docs/guides/troubleshooting-flux-node-status-issues)
...
1. Fix DOS or EXPIRED status (see [Troubleshooting Flux Node Status Issues](/docs/guides/troubleshooting-flux-node-status-issues))
...
- [Flux Fusion Bridge Guide](/docs/guides/flux-fusion-bridge-guide) - Bridging between Flux parallel chains
- [Troubleshooting Flux Node Status Issues](/docs/guides/troubleshooting-flux-node-status-issues) - Maintaining CONFIRMED node status
- [Flux Nodes FAQ](/docs/faq/flux-nodes-faq) - Common FluxNode questions
- [Parallel Assets FAQ](/docs/faq/parallel-assets-faq) - Quick answers to PA claim questions
