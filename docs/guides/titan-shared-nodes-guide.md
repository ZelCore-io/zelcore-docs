...
- [How do I know which wallet is active?](/docs/faq/apps-faq#how-do-i-know-which-wallet-is-active-when-using-zelcore-apps)
...
- [I sent payment for app purchase to wrong wallet](/docs/faq/apps-faq#i-sent-payment-for-an-app-purchase-dao-titan-marketplace-presearch-but-it-went-to-the-wrong-wallet-what-happened)
...
- See: [How to verify active wallet](/docs/faq/apps-faq#how-do-i-know-which-wallet-is-active-when-using-zelcore-apps)
...
- [ZelCore Apps FAQ](/docs/faq/apps-faq) - General app purchase issues, wrong wallet troubleshooting
- [Flux Nodes FAQ](/docs/faq/flux-nodes-faq) - Understanding Flux nodes
