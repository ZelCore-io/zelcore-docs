...
**Related:**
- [ZelCore Installation Guide](/docs/get-started/installation) - How to install desktop version
- [Wallet FAQ](/docs/faq/wallet-faq) - General wallet questions
- [Fusion FAQ](/docs/faq/fusion-faq) - Swap functionality details (desktop/Android)
...
**Related:**
- [Getting Started with ZelCore](/docs/get-started/installation)
...
- [Wallet Backup and Recovery](/docs/get-started/wallet-backup)
...
**Related:**
- [Security Best Practices](/docs/guides/security-best-practices)
- [Wallet Backup Guide](/docs/get-started/wallet-backup)
...
- [Getting Started Guide](/docs/get-started/installation)
